...
public class RestitutionPopupMenu extends KeyPopupMenu
{
	public static final long serialVersionUID = 0l;

	public RestitutionPopupMenu(TabEditorButton button, TabEditor editor)
	{
		super(button, editor);
	}
	...
	protected void init()
	{
		...
		this.add(new SetCountMenuItem(editor, button, "Belege drucken...", "action.count"));
