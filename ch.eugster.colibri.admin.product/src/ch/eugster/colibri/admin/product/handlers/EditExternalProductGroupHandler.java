...
public class EditExternalProductGroupHandler extends AbstractPersistenceClientHandler
{
	@Override
	public Object execute(final ExecutionEvent event) throws ExecutionException
	{
		if (event.getApplicationContext() instanceof EvaluationContext)
		{
			...
			if (object instanceof StructuredSelection)
			{
				...
				if (ssel.getFirstElement() instanceof ExternalProductGroup)
				{
					Activator.getDefault().editExternalProductGroup((ExternalProductGroup) ssel.getFirstElement());
				}
			}
		}
		return null;
