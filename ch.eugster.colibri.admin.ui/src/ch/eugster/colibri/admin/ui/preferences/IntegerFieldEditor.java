...
/**
 * A field editor for a integer type preference.
 * <p>
...
public class IntegerFieldEditor extends FieldEditor {
    ...
    /**
     * Creates a integer field editor.
     ...
     * @since 2.0
     */
    public IntegerFieldEditor(String name, String labelText, int width,
    ...
    /**
     * Creates a integer field editor of unlimited width.
     * Use the method <code>setTextLimit</code> to limit the text.
     * 
     * @param name the name of the preference this field editor works on
     * @param labelText the label text of the field editor
    ...
    protected void doLoadDefault() {
        if (textField != null) {
            currentValue = getPreferenceStore().getDefaultInt(getPreferenceName());
            textField.setText(currentValue.toString());
        }
        valueChanged();
    }
	...
	protected boolean checkState()
	{
		...
		try
		{
			currentValue = Integer.valueOf(numberString);
