 ...
 * </p>
 */
public class DoubleFieldEditor extends FieldEditor {
     ...
     */
    private boolean emptyStringAllowed = false;
	...
	private double minValidValue = 0d;
    ...
    protected void doLoadDefault() {
        if (textField != null) {
            currentValue = getPreferenceStore().getDefaultDouble(getPreferenceName());
            textField.setText(currentValue.toString());
        }
        valueChanged();
    }
    ...
    protected void doStore() {
        getPreferenceStore().setValue(getPreferenceName(), currentValue.doubleValue());
    }
    ...
    public Text getTextControl(Composite parent) {
        if (textField == null) {
            textField = new Text(parent, SWT.SINGLE | SWT.BORDER | SWT.RIGHT);
    ...
    protected void valueChanged() {
        ...
        try
        {
        	currentValue = Double.valueOf(textField.getText());
        }
        catch (NumberFormatException e)
        {
        	currentValue = Double.valueOf(0d);
        }
	...
	/*
	 * (non-Javadoc) Method declared on DoubleFieldEditor. Checks whether the
	 * entered String is a valid double or not.
	 */
	protected boolean checkState()
	{
		...
		try
		{
			currentValue = Double.valueOf(numberString);
	...
	{
		return currentValue == null ? 0d : currentValue.doubleValue();
	}
