...
public class EditMoneyHandler extends AbstractPersistenceClientHandler
{
	@Override
	public Object execute(final ExecutionEvent event) throws ExecutionException
	{
		if (event.getApplicationContext() instanceof EvaluationContext)
		{
			...
			if (object instanceof StructuredSelection)
			{
				...
				if (ssel.getFirstElement() instanceof Money)
				{
					Activator.getDefault().editMoney((Money) ssel.getFirstElement());
				}
			}
		}
		return null;
