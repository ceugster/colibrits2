...
public class CServiceLocator extends org.apache.axis.client.Service implements org.tempuri.CService {

    public CServiceLocator() {
    }


    public CServiceLocator(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public CServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for BasicHttpBinding_IService
    private java.lang.String BasicHttpBinding_IService_address = "http://comelivres201.dnsalias.net:9001/GCDService/";
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://tempuri.org/", "CService");
    }
