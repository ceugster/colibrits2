package ch.eugster.colibri.report.time;
...
import ch.eugster.colibri.report.time.views.TimeRangeView;

public class ReportTimeRangePerspective implements IPerspectiveFactory
{
	public static final String ID = "ch.eugster.colibri.report.timerange.perspective";
	...
	public void createInitialLayout(final IPageLayout layout)
	{
		...
		layout.addView(TimeRangeView.ID, IPageLayout.RIGHT, .7F, "org.eclipse.ui.editorss");
