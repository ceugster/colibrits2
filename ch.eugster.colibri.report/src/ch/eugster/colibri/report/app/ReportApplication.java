...
public class ReportApplication implements IApplication
{
	...
	public Object start(final IApplicationContext context) throws Exception
	{
		...
		if (logService != null)
		{
			logService.log(LogService.LOG_INFO, "Anwendung " + ch.eugster.colibri.report.Activator.PLUGIN_ID + " gestartet");
		}
		...
		try
		{
			...
			{
				returnCode = PlatformUI.createAndRunWorkbench(display, new ReportApplicationWorkbenchAdvisor(context));
			}
