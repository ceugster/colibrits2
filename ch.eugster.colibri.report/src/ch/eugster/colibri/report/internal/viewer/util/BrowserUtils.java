 ...
 */
package ch.eugster.colibri.report.internal.viewer.util;
...
public class BrowserUtils
{
	...
	private static Process launchBrowser(final String url) throws IOException
	{
	...
	private static void reportError(final Display display)
	{
	...
	private static class Launcher implements Runnable
	{
		...
		Launcher(final Display display, final String url)
		{
			this.url = url;
