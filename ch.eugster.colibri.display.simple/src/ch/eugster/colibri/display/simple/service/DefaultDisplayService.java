...
import ch.eugster.colibri.display.simple.area.DefaultLayoutType;
import ch.eugster.colibri.periphery.display.service.CustomerDisplayService;
import ch.eugster.colibri.persistence.model.Payment;
import ch.eugster.colibri.persistence.model.Position;

public class DefaultDisplayService extends AbstractDisplayService implements DisplayService
{
	...
	{
		return new DefaultLayoutType(customerDisplayService);
	}
